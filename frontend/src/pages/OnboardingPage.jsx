...
//   <div className="bg-base-100 w-full max-w-4xl shadow-xl rounded-2xl overflow-hidden">
//     <div className="p-6 sm:p-10">
//       {/* Header */}
//       <div className="text-center mb-8">
//         <h1 className="text-3xl font-bold text-primary">Finish Setting Up Your Profile</h1>
//         <p className="text-sm text-white/70 mt-2">
//   This helps others know more about you and match you better.
// </p>
...
//           <div className="size-32 rounded-full bg-base-300 overflow-hidden border shadow">
...
//             className="btn btn-accent mt-4 btn-sm"
//           >
...
//           <div className="grid md:grid-cols-2 gap-4">
//             <div className="form-control">
//               <label className="label font-medium">Native Language</label>
//               <select
//                 name="nativeLanguage"
...
//             <div className="form-control">
//               <label className="label font-medium">Learning Language</label>
//               <select
